...
// wangbo start move rootwindow
#include "content/browser/renderer_host/render_view_move_root_window.h"
...
RenderViewHostImpl::RenderViewHostImpl(
    ...
    : render_widget_host_(std::move(widget)),
      ...
      // wangbo start move rootwindow
      move_root_window_callback_(nullptr) {
      // wangbo end
...
void RenderViewHostImpl::OnStartMoveRootWindow() {
  if (move_root_window_callback_ != nullptr)
    move_root_window_callback_->SetMoveWindow(true);
}

void RenderViewHostImpl::SetMoveRootWindowCallback(
  RenderViewMoveRootWindow* callback) {
  move_root_window_callback_ = callback;
}
// wangbo end
