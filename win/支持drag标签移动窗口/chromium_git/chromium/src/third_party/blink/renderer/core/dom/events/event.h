...
class CORE_EXPORT Event : public ScriptWrappable {
 ...
 public:
  ...
  bool MoveRootWindowEnabled() const { return move_rootwindow_enabled_; }
  virtual void moveRootWindow();
  void setMoveRootWindow(bool move_enabled) { move_rootwindow_enabled_ = move_enabled; }
  // wangbo end
 ...
 private:
  ...
  // wangbo start move rootwindow
  unsigned move_rootwindow_enabled_ : 1;
  // wangbo end
