...
void CefContentRendererClient::RenderThreadStarted() {
  ...
  // wangbo start owcr scheme
  blink::WebString owcr_scheme("owcr");
  blink::SchemeRegistry::RegisterURLSchemeAsSecure("owcr");
  blink::WebSecurityPolicy::AddSchemeToSecureContextSafelist(owcr_scheme);
  // wangbo end
}
